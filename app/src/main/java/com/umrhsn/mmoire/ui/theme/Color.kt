...
val BackgroundDark = Color(0xFF0A0A0C) // Near black
val SurfaceDark = Color(0xFF1C1C1E)    // Deep grey
val SurfaceVariantDark = Color(0xFF2C2C2E)

// Accents
val MemoireAccent = Color(0xFFFFD600) // Electric Gold
val MemoireError = Color(0xFFFF453A)  // iOS-style soft red
